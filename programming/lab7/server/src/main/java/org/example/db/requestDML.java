...
public class requestDML {
    ...
    private static final String updateByIdRoute = "UPDATE route SET name = ?, x = ?, y = ?, creation_date = ?, location_to_x = ?, location_to_y = ?, location_to_z = ?, location_to_name = ?, location_from_x = ?, location_from_y = ?, location_from_z = ?, location_from_name = ?, distance = ? WHERE id = ? AND owner_id = ?";
    private static final String updateByKeyRoute = "UPDATE route SET name = ?, x = ?, y = ?, creation_date = ?, location_to_x = ?, location_to_y = ?, location_to_z = ?, location_to_name = ?, location_from_x = ?, location_from_y = ?, location_from_z = ?, location_from_name = ?, distance = ? WHERE route_key = ? AND owner_id = ?";
    ...
    private static final String clearUserConnection = "DELETE FROM route WHERE owner_id = ?";
    ...
    public static String getUpdateByIdRoute() {
        return updateByIdRoute;
    }
    public static String getUpdateByKeyRoute() {
        return updateByKeyRoute;
    }
    ...
    public static String getClearUserConnection(){ return clearUserConnection;
    }
}
